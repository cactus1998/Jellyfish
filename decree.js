...
const answers = [
    ...
    "答案之書今天公休，明天請早。", "答案被我吃掉了。", "（已讀不回）", "我要去洗澡了", "是", "不是", "不知道", "我不知道", 
    "擲個硬幣吧，雖然結果可能還是不準。", "就算知道答案，你也不會照做的。", "先轉帳 500 塊再來問。", "媽，我在這裡！（揮手）", "你的問題太深奧了，我需要十年來思考。", 
    "這題跳過，下一題。", "這問題就像問拔獅子的鬃毛會不會長頭髮一樣。", "你去問樓下管理員比較快。", "為什麼要問我？我又不是你媽。", "如果我是你，我就不會問這個。",
];
