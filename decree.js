...
// 無理頭答案清單
const answers = [
    "問得好，但我不想回答。", "不知道但我想吃冰。", "去問你媽啦，她可能知道。", "你的問題讓我翻了個白眼。", "我不知道ㄝ。", 
    "今天公休，明天請早。", "答案被我吃掉了。", "（已讀不回）", "我要去洗澡了", "是", "不是", "不知道", "我不知道", 
    "什麼鳥問題。", "就算知道答案，你也不會照做的。", "先轉帳 500 塊再來問。", "你的問題太深奧了，我需要十年來思考。", 
...
async function executeDecree(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setFooter({ text: '隨機抽取請勿當真•', iconURL: interaction.client.user.displayAvatarURL() })
        .setTimestamp();
